...
app.service('userService',function($http){
    ...
    this.cancelSeckillOrder=function(id){
        return $http.get('../seckillOrder/cancelSeckillOrder.do?id='+id);
    }

    this.findOrderById=function(id){
        return $http.get('../seckillOrder/findOrderCreateTimeById.do?id='+id);
    }
