//服务层
app.service('sellerUserService',function($http){
    ...
    this.userFindCount = function(){
        return $http.get('../user/findCount.do');
    }

    this.findActiveCount = function(){
        return $http.get('../user/findActiveCount.do');
    }
});
