...
app.service('specificationService', function ($http) {
    ...
    this.searchStatus = function (page, rows, searchEntity) {
        return $http.post('../specificationStatus/search.do?page=' + page + "&rows=" + rows, searchEntity);
    }
    //修改状态
    this.updateStatus = function (ids, status) {
        return $http.get('../specificationStatus/updateStatus.do?ids=' + ids + "&status=" + status);
    }
});
